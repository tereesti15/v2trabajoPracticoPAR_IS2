<div class="flex p-6">
    ...
    <div class="w-3/4 pl-6">
        @if($activeComponent === 'empleado-crud')
            <livewire:empleado-crud />
        @elseif($activeComponent === 'empleado-create')
            <livewire:empleado-create />
        @elseif($activeComponent === 'persona-crud')
            <livewire:persona-crud />
        @elseif($activeComponent === 'persona-create')
            <livewire:persona-create />
        @elseif($activeComponent === 'hijos-crud')
            <livewire:hijos-crud />
        @elseif($activeComponent === 'hijo-create')
            <livewire:hijo-create />
        @elseif($activeComponent === 'reporte-panel')
